...
def train_model_s01(dataset_path):
    ...
    # Seleção de features (mesmas colunas excluídas da S13)
    ...
    print(f"🚀 Treinando LightGBM para S01 com {len(X_train)} amostras e {len(features)} features...")
    ...
    model_path = 'corretora-evemex/signal_filter_s01.pkl'
    joblib.dump(model_data, model_path)
    print(f"\n✨ Modelo salvo em {model_path}")

if __name__ == "__main__":
    train_aligned_model("s01", Path(__file__).parent / "ml_dataset_s01.csv")
